...
This is the first technical Codegisoft project it tests more on Git, GitHub, GitHub Workflow and Linters.
...
sh
  cd my-folder
  git clone https://github.com/ngehjosephrya/Hello-CodegiSoft-Acaedemy.git
...
- GitHub: [@ngehjosephrya](https://github.com/ngehjosephrya/Hello-CodegiSoft-Acaedemy.git)
